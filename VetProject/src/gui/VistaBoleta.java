...
private String idVete;
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnListar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 510, 190, 50));
        ...
        jPanel1.add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 510, 190, 50));
        ...
        jPanel1.add(btnBoleta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 510, 190, 50));
    ...
    private void btnBoletaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBoletaActionPerformed
        ...
        if (filaSeleccionada >=0) {
            String idCliente = tblVeterinario.getValueAt(filaSeleccionada, 2).toString();
            String idMascot = tblVeterinario.getValueAt(filaSeleccionada, 3).toString();
            String tPrimario =  tblVeterinario.getValueAt(filaSeleccionada, 4).toString();
            String tSegundario =  tblVeterinario.getValueAt(filaSeleccionada, 5).toString();
            String idVet = tblVeterinario.getValueAt(filaSeleccionada, 10).toString();
            int Boton =1;
